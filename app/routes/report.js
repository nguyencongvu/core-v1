var modelName = 'report'; //--edit here movie to user modelName = viewName
...
function searchMiddle(req, res, next){
    ...
    if (    
            !searchValue &&
            !inString(urlPath,"reports/report") &&
            !inString(urlPath,"reports/excel") && 
            !inString(urlPath,"reports/json") &&
            !inString(urlPath,"reports/jsonmap")
        )
    { 
